...
var WeWork4U_3;
(function (WeWork4U_3) {
    WeWork4U_3.tableE = document.createElement("table");
    WeWork4U_3.tableH = document.createElement("table");
    WeWork4U_3.tableA = document.createElement("table");
    function generateTableE() {
        ...
        tH5.innerHTML = ("Laden");
        tab.appendChild(WeWork4U_3.tableE);
        WeWork4U_3.tableE.appendChild(groupHead);
    ...
    WeWork4U_3.generateTableE = generateTableE;
    function generateTableH() {
        ...
        tab.appendChild(WeWork4U_3.tableH);
        WeWork4U_3.tableH.appendChild(groupHead);
        groupHead.appendChild(tH1);
        groupHead.appendChild(tH2);
        groupHead.appendChild(tH3);
        groupHead.appendChild(tH4);
    ...
    WeWork4U_3.generateTableH = generateTableH;
    function generateTableA() {
        ...
        tab.appendChild(WeWork4U_3.tableA);
        WeWork4U_3.tableA.appendChild(groupHead);
        groupHead.appendChild(tH1);
        groupHead.appendChild(tH2);
        groupHead.appendChild(tH3);
    ...
    WeWork4U_3.generateTableA = generateTableA;
