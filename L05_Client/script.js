...
(function (WeWork4U_3) {
    ...
    async function init(_event) {
        ...
        WeWork4U_3.generateTableE();
        WeWork4U_3.generateTableH();
        WeWork4U_3.generateTableA();
        WeWork4U_3.generateContent(data);
    ...
    function resetOrder(_event) {
        WeWork4U_3.tableE.innerHTML = "";
        amount.innerHTML = "";
        WeWork4U_3.tableH.innerHTML = "";
        WeWork4U_3.tableA.innerHTML = "";
    }
    // create Table-Rows
    function createLineE() {
        let groupRow = document.createElement("tr");
        WeWork4U_3.tableE.appendChild(groupRow);
        //
    ...
    function createLineH() {
        let groupRow = document.createElement("tr");
        WeWork4U_3.tableH.appendChild(groupRow);
        //
        let formData = new FormData(document.querySelector("form"));
        for (let entry of formData) {
            let selector = "[value='" + entry[1] + "']";
    ...
    function createLineA() {
        let groupRow = document.createElement("tr");
        WeWork4U_3.tableA.appendChild(groupRow);
        //
        let formData = new FormData(document.querySelector("form"));
        for (let entry of formData) {
            let selector = "[value='" + entry[1] + "']";
