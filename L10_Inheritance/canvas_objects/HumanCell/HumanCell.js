...
(function (CanvasVirusus_V3) {
    class HumanCell extends CanvasVirusus_V3.Moveable {
        ...
        drawHealthy() {
            ...
            CanvasVirusus_V3.crc2.ellipse(0, 0, 60, 35, 10, 0.8, 1.3 * Math.PI);
            CanvasVirusus_V3.crc2.ellipse(-55, -6, 60, 35, 24.8, 2.3, 1.7 * Math.PI);
            CanvasVirusus_V3.crc2.closePath();
            CanvasVirusus_V3.crc2.fillStyle = "#ffd1e1";
            CanvasVirusus_V3.crc2.lineWidth = 3;
            CanvasVirusus_V3.crc2.strokeStyle = "#9c214c";
            CanvasVirusus_V3.crc2.closePath();
            CanvasVirusus_V3.crc2.stroke();
            CanvasVirusus_V3.crc2.fill();
            CanvasVirusus_V3.crc2.beginPath();
            CanvasVirusus_V3.crc2.ellipse(15, 10, 20, 12, 10, 0, 2 * Math.PI);
            CanvasVirusus_V3.crc2.fillStyle = "#eaa1b3";
        ...
        drawInfected() {
            ...
            CanvasVirusus_V3.crc2.ellipse(-55, -6, 60, 35, 24.8, 2.3, 1.7 * Math.PI);
            CanvasVirusus_V3.crc2.closePath();
            CanvasVirusus_V3.crc2.fillStyle = "#8a303a";
            CanvasVirusus_V3.crc2.lineWidth = 3;
            CanvasVirusus_V3.crc2.strokeStyle = "#331c1c";
            CanvasVirusus_V3.crc2.closePath();
            CanvasVirusus_V3.crc2.stroke();
            CanvasVirusus_V3.crc2.fill();
            CanvasVirusus_V3.crc2.beginPath();
            CanvasVirusus_V3.crc2.ellipse(15, 10, 20, 12, 10, 0, 2 * Math.PI);
            CanvasVirusus_V3.crc2.fillStyle = "#733641";
            CanvasVirusus_V3.crc2.lineWidth = 1;
            CanvasVirusus_V3.crc2.closePath();
            CanvasVirusus_V3.crc2.fill();
            CanvasVirusus_V3.crc2.stroke();
    ...
    CanvasVirusus_V3.HumanCell = HumanCell;
