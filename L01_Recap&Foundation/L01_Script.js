...
// Variablen
var v = 1; // zuerst muss mit Schlüsselwort "let" die Variable deklariert werden, dann kann sie durch einen Inhalt definiert werden
v = v + 1;
console.log(v);
// Datentypen
var w = 1; // TS verlangt Typisierung/Annotation, erkennt durch Inhalt das Typ "number" vorliegt
w = w + 1;
console.log(w);
var x = "1"; // TS verlangt Typisierung/Annotation, erkennt durch Inhalt das Typ "string" vorliegt
x = x + 1;
console.log(x);
var y = true; // durch "true" als Schlüsselwort erkennt TS das es sich um den Typ "boolean" handelt 
y = y + 1; // Additionsoperator "+" kann bei einem Boolean nicht verwendet werden 
console.log(y);
// Explizite Typisierung
var a = true; // nach Annotation wird ein anderer Inhalt als ein Zahlenwert ls Fehler angezeigt 
a = a + 1;
console.log(a);
var b = 1;
...
console.log(b);
// Array
var c = [7, true, "Hallo"]; // heterogenes Array, Elemente mit unterschiedliche Typen
...
var d = [7, true, "Hallo"]; // eingeschränktes Array = homogen, Fehler da <true + "Hallo"> nicht Typ "number" entsprechen
// Assoziatives Array
var e1 = { "zahl": 7, "wahr": true, "text": "Hallo" };
var e2 = { zahl: 7, wahr: true, "text": "Hallo" }; //// Key/Schlüssel können sowohl in "Anführungszeichen" als auch Ohne geschrieben werden
...
// Werte vs. Referenzen
var f1; //   ↓          
var f2; // Deklaration zweier Variablen - primitiver Typ
...
var g1 = [1, 6, 8, 2]; // Deklaration einer Variable - komplexen Typs + Definition
var g2 = g1; // Deklaration einer zweiten Variable - kom.T. + zusweisen der Werte der Ersten zur Zweiten
